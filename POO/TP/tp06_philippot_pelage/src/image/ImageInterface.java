...
public interface ImageInterface {
    ...
    /**
     * Change a color of pixel
     *
     * @param x : (type-int)
     * @param y : (type-int)
     * @param level : (type-GrayColor)
     * @exception UnknownPixelException :
     */
    public void changeColorPixel(int x, int y, GrayColor level) throws UnknownPixelException;
    ...
    /**
     * Decrease the grayLevel
     *
     * @param nbGrayLevels : (type-int)
     * @return : (type-Image)
     */
